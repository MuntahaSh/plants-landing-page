...
// when press on link fo to the hole page as i press on close icon 
...
//  make sure to add id to each section and add class nav-link to each link in the navbar , the same as the id 
const activeLink =()=> {
  ...
  sections.forEach(section=>{
    const sectionTop = section.offsetTop - parseInt(getComputedStyle(section).scrollMarginTop || 0);
...
// scroll reveal animation   ==>make animation when home parts appear 
